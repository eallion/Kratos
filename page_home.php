...
<html class="no-js">
	<head>
		...
		<link rel='stylesheet' id='bootstrap-style-css'  href='//lib.baomitu.com/bootstrap/3.3.7/css/bootstrap.min.css' type='text/css' media='all' />
							...
							<div class="nav-header">
								...
								<nav id="kratos-menu-wrap" class="menu-container">
									<ul id="kratos-primary-menu" class="sf-menu">
										<li class="current-menu-item"><a href="<?php $this->options ->siteUrl(); ?>/blog/">Blog</a></li>
...
<div class="kratos-cover kratos-topimg text-center" style="background-image: url(<?php ($this->options->bannerimg) ? $this->options->bannerimg() : $this->options->themeUrl('images/background.jpg'); ?>)">
		<div class="desc animate-box">
			<h2><?php $this->options->logoTxt(); ?></h2>
			<span><?php $this->options->description();?></span>
			<span><b class="btn btn-star" id="top-Start"><a href="<?php $this->options ->siteUrl(); ?>/blog/">探索更多</a></b></span>
		</div>
	</div>
</div>
<!-- Kratos Start Over :-) -->
